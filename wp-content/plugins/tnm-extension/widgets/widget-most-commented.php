<?php
/**
 * Plugin Name: [TNM] Widget Most Commented
...
class bk_widget_most_commented_posts extends WP_Widget {
	...
	function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'bk_widget_most_commented_posts', esc_html__('[TNM] Widget Most Commented', 'the-next-mag'), $widget_ops);
	}
	...
	function widget( $args, $instance ) {
        ...
        $widgetClass = 'mnmd-widget-most-commented';
		...
		if ( $the_query -> have_posts() ) :
            ...
            echo tnm_widget::bk_most_commented($the_query);
            echo '</ol>';
