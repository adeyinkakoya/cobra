<?php
/**
 * Plugin Name: [TNM] Widget Posts List
...
class bk_widget_posts_list extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'mnmd-widget', 'description' => esc_html__('Displays Posts List.', 'the-next-mag') );

		/* Create the widget. */
		parent::__construct( 'bk_widget_posts_list', esc_html__('[TNM] Widget Posts List', 'the-next-mag'), $widget_ops);
	}
	...
	function widget( $args, $instance ) {
        ...
        $widgetClass = tnm_widget::bk_get_widget_module_class($widgetModule);
        ...
        $widgetMeta = array();
        $widgetMeta = tnm_widget::bk_widget_meta($widget_opts['orderby']);
		...
		if ( $the_query -> have_posts() ) :
            ...
            switch ( $widgetModule ) {
                case 'indexed-posts-a' :
                    ...
                    echo tnm_widget::bk_listing_posts_a_render($the_query, $widgetMeta);
                    echo '</ol>';
                    break;
                
                case 'indexed-posts-b' :
                    echo '<ol class="posts-list list-space-sm list-unstyled">';
                    echo tnm_widget::bk_listing_posts_b_render($the_query, $widgetMeta);
                    echo '</ol>';
                    break;
                ...
                case 'indexed-posts-c' :
                    ...
                    echo tnm_widget::bk_indexed_posts_c_render($the_query, $widgetMeta);
                    break;
                ...
                case 'posts-listing-c' :
                    echo '<div class="widget-content">';
                    echo '<ul class="list-unstyled list-space-sm">';
                    echo tnm_widget::bk_listing_posts_c_render($the_query, $widgetMeta);
                    echo '</ul>';
                    echo '</div>';
                    break;
                ...
                case 'posts-listing-d' :
                    ...
                    echo tnm_widget::bk_listing_posts_d_render($the_query, $widgetMeta);
                    echo '</ul>';
                    break;
                
                case 'posts-listing-e' :
                    echo '<ol class="posts-list list-space-sm list-unstyled">';
                    echo tnm_widget::bk_listing_posts_e_render($the_query, $widgetMeta);
                    echo '</ol>';
                    break;
