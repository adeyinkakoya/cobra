...
if ( ! function_exists( 'bk_page_builder_temp' ) ) {
	function bk_page_builder_temp() {
        ...
        $tempString .= '<div class="bk-section-empty">'.esc_html__( 'Choose Layout section to add new section.', 'tnm').'</div>';
        $tempString .= '<div class="bk-section-loading">'.esc_html__( 'Loading ...', 'tnm' ).'</div>';
        $tempString .= '</div>';
        ...
        $tempString .= '<input class="bk-field taxonomy_image" type="text" name="taxonomy_image" value="" />
                            ...
                            <br/>
                    		<button class="tnm_upload_image_button button">' . esc_html__('Upload/Add image', 'tnm') . '</button>
                    		<button class="tnm_remove_image_button button">' . esc_html__('Remove image', 'tnm') . '</button>
                            </div>
                            ';
        $tempString .= '</script>';
        ...
        $tempString .= '<div class="sidebar"><label>'.esc_html__('Choose a sidebar', 'tnm').'</label>';
        $tempString .= '<select class = "bk-sidebar-order">';
        $tempString .= '<option value="0">'.esc_html__( 'None', 'tnm' ).'</option>';
        ...
        $tempString .= '<option value="right">'.esc_html__( 'Right Sidebar', 'tnm' ).'</option>';
        $tempString .= '<option value="left">'.esc_html__( 'Left Sidebar', 'tnm' ).'</option>';
        $tempString .= '</select>';
        $tempString .= '</div>';
        $tempString .= '</script>';
        ...
        $tempString .= esc_html__( 'Add Module', 'tnm' );
        ...
        $tempString .= '<div class="bk-section-empty">'.esc_html__( 'Click Add Module button to add new module.', 'tnm' ).'</div>';
        $tempString .= '<div class="bk-section-loading">'.esc_html__( 'Loading ...', 'tnm' ).'</div>';
        $tempString .= '</div>';
        $tempString .= '</div>';
        $tempString .= '</div>';
        ...
        $tempString .= '<input type="hidden" class="bk-section-type">';
        $tempString .= '<div class="bk-section-empty">'.esc_html__( 'Click Add Module button to add new section.', 'tnm' ).'</div>';
        $tempString .= '<div class="bk-section-loading">'.esc_html__( 'Loading ...', 'tnm' ).'</div>';
        $tempString .= '</div>';
        ...
        $tempString .= '<input type="hidden" class="bk-section-type">';
        $tempString .= '<div class="bk-section-empty">'.esc_html__( 'Click Add Module button to add new module.', 'tnm' ).'</div>';
        $tempString .= '<div class="bk-section-loading"><i class="icon-entypo-arrows-ccw"></i> '.esc_html__( 'Loading ...', 'tnm' ).'</div>';
        $tempString .= '</div>';
        ...
        echo html_entity_decode( $tempString );                    
	}
}