<?php
if (!class_exists('tnm_cache')) {
    class tnm_cache {
        
        static $cache_name_format = '{group}-{ID}';
        
        static function tnm_get_cache_name( $cache_key, $cache_group = '' ) {

    		$cache_group = self::tnm_sanitize_group_name( $cache_group );
        ...
        static function tnm_get_cache( $cache_key, $cache_group = 'default' ) {

    		$transient_name = self::tnm_get_cache_name( $cache_key, $cache_group );
        ...
        static function tnm_set_cache( $cache_key, $data2cache, $cache_group = 'default', $expiration = NULL ) {
        ...
        static function tnm_sanitize_group_name( $cache_key, $cache_group = '' ) {
