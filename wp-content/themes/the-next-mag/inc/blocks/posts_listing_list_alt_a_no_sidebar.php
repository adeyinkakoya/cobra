<?php
if (!class_exists('tnm_posts_listing_list_alt_a_no_sidebar')) {
    class tnm_posts_listing_list_alt_a_no_sidebar {
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('tnm_posts_listing_list_alt_a_no_sidebar-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            if ( $the_query->have_posts() ) :
                ...
                while ( $the_query->have_posts() ): $the_query->the_post();    
                    ...
                    if($currentPost % 5) :
                        ...
                        $postHorizontalAttr_L['typescale'] = 'typescale-4';
