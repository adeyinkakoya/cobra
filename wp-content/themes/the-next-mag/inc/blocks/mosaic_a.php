            ...
            if ( $the_query->have_posts() ) :
                ...
                while ( $the_query->have_posts() ): $the_query->the_post();     
                    ...
                    if($the_query->current_post == 0) :
                        ...
                        $postOverlayAttr_L['thumbSize']     = 'tnm-s-1_1';
                        ...
                        $render_modules .= '<div class="mosaic-item mosaic-item--lg col-xs-12 col-md-6">';
