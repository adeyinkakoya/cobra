<?php
if (!class_exists('tnm_carousel_overlay_post_main_col_1i')) {
    class tnm_carousel_overlay_post_main_col_1i {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('tnm_carousel_overlay_post_main_col_1i-');
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div id="'.$moduleID.'" class="mnmd-block mnmd-carousel mnmd-carousel-dots-none mnmd-carousel-nav-c">';
