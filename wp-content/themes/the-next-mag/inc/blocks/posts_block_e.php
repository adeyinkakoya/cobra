<?php
if (!class_exists('tnm_posts_block_e')) {
    class tnm_posts_block_e {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('tnm_posts_block_e-');
        ...
        public function render_modules ($the_query, $moduleInfo = ''){
            ...
            if ( $the_query->have_posts() ) :
                $postOverlayAttr = array (
                    ...
                    'additionalClass'   => 'post--overlay-bottom post--overlay-sm post--overlay-floorfade',
