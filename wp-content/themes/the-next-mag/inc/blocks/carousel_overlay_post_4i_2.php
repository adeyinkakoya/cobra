<?php
if (!class_exists('tnm_carousel_overlay_post_4i_2')) {
    class tnm_carousel_overlay_post_4i_2 {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('tnm_carousel_overlay_post_4i_2-');
            ...
            if ( $the_query->have_posts() ) :
                ...
                $block_str .= '<div id="'.$carouselID.'" class="mnmd-carousel__inner owl-carousel js-carousel-4i4m" data-carousel-loop="'.$moduleConfigs['carousel_loop'].'">';
        ...
        public function get_post_icon_class($postSource){
            ...
            if(($postSource == 'video') || ($postSource == 'review')) {
                $postIconClass = 'badge-bottom post-type-icon--md';
