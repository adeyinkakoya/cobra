<?php
if (!class_exists('tnm_posts_listing_list_alt_b_no_sidebar')) {
    class tnm_posts_listing_list_alt_b_no_sidebar {
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('tnm_posts_listing_list_alt_b_no_sidebar-');
            $moduleConfigs = array();
