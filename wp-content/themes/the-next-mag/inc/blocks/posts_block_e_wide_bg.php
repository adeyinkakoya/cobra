<?php
if (!class_exists('tnm_posts_block_e_wide_bg')) {
    class tnm_posts_block_e_wide_bg {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('tnm_posts_block_e_wide_bg-');
            ...
            $block_str .= '<div id="'.$moduleID.'" class="mnmd-block mnmd-block--fullwidth mnmd-mosaic mnmd-mosaic--has-shadow mnmd-mosaic--gutter-10 has-overlap-background '.$contiguousClass.'">';
            ...
            if ( $the_query->have_posts() ) :
                ...
                while ( $the_query->have_posts() ): $the_query->the_post();
                    ...
                    if($the_query->current_post == 0){
                        ...
                        $postOverlayAttr_L['thumbSize'] = 'tnm-s-4_3';
                        $postOverlayAttr_L['typescale'] = 'typescale-3';
                        ...
                        $render_modules .= '<div class="mosaic-item col-xs-12 col-md-6">';
                        ...
                        $render_modules .= '<div class="mosaic-item col-xs-12 col-sm-6 col-md-3">';
