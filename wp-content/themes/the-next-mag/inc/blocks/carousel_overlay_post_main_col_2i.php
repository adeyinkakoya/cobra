<?php
if (!class_exists('tnm_carousel_overlay_post_main_col_2i')) {
    class tnm_carousel_overlay_post_main_col_2i {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('tnm_carousel_overlay_post_main_col_2i-');
            ...
            if ( $the_query->have_posts() ) :
                ...
                $block_str .= '<div id="'.$carouselID.'" class="owl-carousel js-carousel-2i4m" data-carousel-loop="'.$moduleConfigs['carousel_loop'].'">';
