<?php
if (!class_exists('tnm_mosaic_a_bg')) {
    class tnm_mosaic_a_bg {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('tnm_mosaic_a_bg-');
...
//Post Source & Icon
            ...
            if($moduleConfigs['bg_option'] == 'image') :
                ...
                $block_str .= '<div class="overlap-background background-img gradient-5" style="
            ...
            if ( $the_query->have_posts() ) :
                ...
                while ( $the_query->have_posts() ): $the_query->the_post();      
                    ...
                    if($the_query->current_post == 0) :
                        ...
                        $render_modules .= '<div class="mosaic-item mosaic-item--half col-xs-12 col-sm-6 col-md-3">';
