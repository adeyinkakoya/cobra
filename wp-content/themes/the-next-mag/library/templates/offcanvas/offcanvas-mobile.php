<?php 
    ...
    if ((isset($tnm_option['bk-offcanvas-mobile-logo'])) && (($tnm_option['bk-offcanvas-mobile-logo']) != NULL)){ 
        $logo = $tnm_option['bk-offcanvas-mobile-logo'];
...
<div id="mnmd-offcanvas-mobile" class="mnmd-offcanvas js-mnmd-offcanvas js-perfect-scrollbar">
	<div class="mnmd-offcanvas__title">
        ...
        <?php if ( isset($tnm_option ['bk-offcanvas-mobile-social']) && ($tnm_option ['bk-offcanvas-mobile-social'] != '') ){ ?>
		<ul class="social-list list-horizontal">
			<?php echo tnm_core::bk_get_social_media_links($tnm_option['bk-offcanvas-mobile-social']);?>
		</ul>
        <?php }?>
	...
	<div class="mnmd-offcanvas__section mnmd-offcanvas__section-navigation">
		<?php 
            if ( isset($tnm_option ['bk-offcanvas-mobile-menu']) && ($tnm_option ['bk-offcanvas-mobile-menu'] != '') ){
                if ( has_nav_menu( $tnm_option ['bk-offcanvas-mobile-menu'] ) ) : 
                    $menuSettings = array( 
                        'theme_location' => $tnm_option ['bk-offcanvas-mobile-menu'],
    ...
    <?php if(isset($tnm_option['bk-offcanvas-mobile-mailchimp-shortcode']) && ($tnm_option['bk-offcanvas-mobile-mailchimp-shortcode'] != '')) :?>
	<div class="mnmd-offcanvas__section">
		<div class="subscribe-form subscribe-form--horizontal text-center">
            <?php echo do_shortcode($tnm_option['bk-offcanvas-mobile-mailchimp-shortcode']);?>
		</div>
	</div>
    <?php endif;?>
